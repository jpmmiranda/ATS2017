    ...
    private void run() {
        ...
        do {
            ...
            switch (menuPrincipal.getOpcao()) {
                case 1:
                    this.menuLogin.executa(this.utilizadores, this.veiculos);
                    break;
                case 2:
                    this.menuRegisto.executa(this.utilizadores, this.veiculos);
                    break;
                case 3:
        ...
        if (cs.size() == 0) {
            ...
            cs.forEach(c -> {
                ...
                sb.append("Nome: ")
                        ...
                        .append(c.getMail())
                        .append(" Montante: ")
                        .append(String.format("%.2f", c.getMS()))
                        .append("€");
            ...
            for (Motorista m : ms) {
                try {
                    ...
                    sb.append("Nome: ")
                            ...
                            .append(m.getMail())
                            .append(" Desvio: ")
                            .append(String.format("%.2f", m.maiorDesvio().getDesvio()));
                    System.out.println(sb);
    ...
    public void funcionalidades() {
        ...
        switch (op) {
            case 1:
                ...
                break;
            case 2:
                this.top10ClientesGastadores();
                break;
            case 3:
                listarVeiculos();
                break;
            case 4:
                this.top5MotoristasComMaiorDesvio();
                break;
            default:
